...
const makeStyles = (T, isDark) => `
  ...
  .PhoneInputCountry {
    ...
    background: ${T.surface2}; padding: 0 10px;
    height: 42px; display: flex; align-items: center;
  }
  .PhoneInputCountrySelectArrow { border-top-color: ${T.textSec}; }
  .PhoneInputCountrySelect { background: ${T.surface}; color: ${T.textPri}; }
